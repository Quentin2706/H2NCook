...
class ClientsManager 
{
	...
	{
 		$db=DbConnect::getDb();
		$q=$db->prepare("INSERT INTO Clients (genre,nom,prenom,DDN,adressePostale,codePostal,ville) VALUES (:genre,:nom,:prenom,:DDN,:adressePostale,:codePostal,:ville)");
	...
	{
 		$db=DbConnect::getDb();
		$q=$db->prepare("UPDATE Clients SET idUser=:idUser,genre=:genre,nom=:nom,prenom=:prenom,DDN=:DDN,adressePostale=:adressePostale,codePostal=:codePostal,ville=:ville WHERE idUser=:idUser");
